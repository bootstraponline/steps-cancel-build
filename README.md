...
Cancel build using the Bitrise API.
...
- `BITRISE_APP_SLUG`   - App slug. Set by bitrise automatically.
- `BITRISE_BUILD_SLUG` - Build slug. Set by bitrise automatically.
- `BITRISE_TOKEN`      - Bitrise API token.
